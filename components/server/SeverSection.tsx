...
export const ServerSection = ({ label, role, sectionType, channelType, server }: IServerSection) => {
    const { onOpen } = useModal()
    return (
        <div className="flex items-center justify-between py-2">
            <p className="text-xs uppercase font-semibold to-zinc-500 dark:text-zinc-400">
                {label}
            </p>
            {
